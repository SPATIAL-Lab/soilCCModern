...
arrows(wq_comp_pre$d13C.measured - C_site_sd, wq_comp_pre$d13C, wq_comp_pre$d13C.measured + C_site_sd, wq_comp_pre$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq_comp_pre$d13C.measured, wq_comp_pre$d13C, pch=1, cex=1.3)
text(-16,10,"a", cex=1.5)
...
arrows(wq_comp_pre$d18O.measured - O_site_sd, wq_comp_pre$d18O, wq_comp_pre$d18O.measured + O_site_sd, wq_comp_pre$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq_comp_pre$d18O.measured, wq_comp_pre$d18O, pch=1, cex=1.3)
text(-27,10,"b", cex=1.5)
...
arrows(dq_comp_pre$d13C.measured - C_site_sd, dq_comp_pre$d13C, dq_comp_pre$d13C.measured + C_site_sd, dq_comp_pre$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq_comp_pre$d13C.measured, dq_comp_pre$d13C, pch=1, cex=1.3)
text(-16,10,"c", cex=1.5)
...
arrows(dq_comp_pre$d18O.measured - O_site_sd, dq_comp_pre$d18O, dq_comp_pre$d18O.measured + O_site_sd, dq_comp_pre$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq_comp_pre$d18O.measured, dq_comp_pre$d18O, pch=1, cex=1.3)
text(-27,10,"d", cex=1.5)

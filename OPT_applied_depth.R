...
for(i in 1: nrow(sites.depth)){
  wq_pred_opt.depth[i,] = sm_forward_opt_wq.depth(sites.depth$Pa[i], sites.depth$Tma[i], sites.depth$PfWQ[i], sites.depth$TmWQ_min_a[i], sites.depth$Ra[i], sites.depth$TmWQ_min_a[i], 3, sites.depth$z[i])
...
for(i in 1: nrow(sites.depth)){
  dq_pred_opt.depth[i,] = sm_forward_opt_dq.depth(sites.depth$Pa[i], sites.depth$Tma[i], sites.depth$Pfdq[i], sites.depth$Tmdq_min_a[i], sites.depth$Ra[i], sites.depth$Tmdq_min_a[i], sites.depth$DQ[i], sites.depth$z[i])
...
c = ceiling(((wq.comp.opt.depth$map.wc) / 1000) * 5)
...
par(mar=c(2,5,1,0))
plot(wq.comp.opt.depth$d13C.measured, wq.comp.opt.depth$d13C, pch=16, col=pal_map[c], xlim=c(-13,4), ylim=c(-13,4), main="", cex = 1.25,
...
arrows(wq.comp.opt.depth$d13C.measured - 1.10, wq.comp.opt.depth$d13C, wq.comp.opt.depth$d13C.measured + 1.10, wq.comp.opt.depth$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
par(mar=c(2,5,1,1))
plot(wq.comp.opt.depth$d18O.measured, wq.comp.opt.depth$d18O, pch=16, col=pal_map[c], xlim=c(-17,1), ylim=c(-17,1),main="",cex = 1.25,
     xlab="",  cex.axis=1.25, cex.lab=1.25,
...
arrows(wq.comp.opt.depth$d18O.measured - 1.09, wq.comp.opt.depth$d18O, wq.comp.opt.depth$d18O.measured + 1.09, wq.comp.opt.depth$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq.comp.opt.depth$d18O.measured, wq.comp.opt.depth$d18O, pch=1, cex=1.3)
text(-17,1,"b", cex=1.5)

par(mar=c(4,5,0,0))
plot(dq.comp.opt.depth$d13C.measured, dq.comp.opt.depth$d13C, pch=16, col=pal_map[c], xlim=c(-13,4), ylim=c(-13,4), main="",cex = 1.25,
...
arrows(dq.comp.opt.depth$d13C.measured - 1.10, dq.comp.opt.depth$d13C, dq.comp.opt.depth$d13C.measured + 1.10, dq.comp.opt.depth$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq.comp.opt.depth$d13C.measured, dq.comp.opt.depth$d13C, pch=1, cex=1.3)
text(-13,4,"c", cex=1.5)

par(mar=c(4,5,0,1))
plot(dq.comp.opt.depth$d18O.measured, dq.comp.opt.depth$d18O, pch=16, col=pal_map[c], xlim=c(-17,1), ylim=c(-17,1), main="",cex = 1.25,
...
arrows(dq.comp.opt.depth$d18O.measured - 1.09, dq.comp.opt.depth$d18O, dq.comp.opt.depth$d18O.measured + 1.09, dq.comp.opt.depth$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)

...
d13C_al.depth <- c(min(c((wq.comp.depth$d13C - wq.comp.depth$d13C_sd), (wq.comp.depth$d13C.measured - wq.comp.depth$d13C_sd), (dq.comp.depth$d13C - dq.comp.depth$d13C_sd), (dq.comp.depth$d13C.measured - dq.comp.depth$d13C_sd))), max(c((wq.comp.depth$d13C + wq.comp.depth$d13C_sd), (wq.comp.depth$d13C.measured + wq.comp.depth$d13C_sd), (dq.comp.depth$d13C + dq.comp.depth$d13C_sd), (dq.comp.depth$d13C.measured + dq.comp.depth$d13C_sd))))
d18O_al.depth <- c(min(c((wq.comp.depth$d18O - wq.comp.depth$d18O_sd), (wq.comp.depth$d18O.measured - wq.comp.depth$d18O_sd), (dq.comp.depth$d18O - dq.comp.depth$d18O_sd), (dq.comp.depth$d18O.measured - dq.comp.depth$d18O_sd))), max(c((wq.comp.depth$d18O + wq.comp.depth$d18O_sd), (wq.comp.depth$d18O.measured + wq.comp.depth$d18O_sd), (dq.comp.depth$d18O + dq.comp.depth$d18O_sd), (dq.comp.depth$d18O.measured + dq.comp.depth$d18O_sd))))

jpeg("Pre_Validation_depth.jpg", units="in", res=300, width=8.5, height=7.5)
...
arrows(wq.comp.depth$d13C.measured - 1.10, wq.comp.depth$d13C, wq.comp.depth$d13C.measured + 1.10, wq.comp.depth$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
arrows(wq.comp.depth$d18O.measured - 1.09, wq.comp.depth$d18O, wq.comp.depth$d18O.measured + 1.09, wq.comp.depth$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
arrows(dq.comp.depth$d13C.measured - 1.10, dq.comp.depth$d13C, dq.comp.depth$d13C.measured + 1.10, dq.comp.depth$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
arrows(dq.comp.depth$d18O.measured - 1.09, dq.comp.depth$d18O, dq.comp.depth$d18O.measured + 1.09, dq.comp.depth$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq.comp.depth$d18O.measured, dq.comp.depth$d18O, pch=1, cex=1.3)
text(-17,2,"d", cex=1.5)

legend("bottomright", title = expression(paste("P"[a]," (mm)")), cex=0.8, fill=pal_map, legend=c("0 - 100", "100 - 200", "200 - 300", "300 - 400", "400 - 500", "500 - 600", "600 - 700", "700 - 800"))

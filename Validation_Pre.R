...
sm_forward_evap = function(Pa, Tma, PfPCQ, TmPCQ_min_a, Ra, TmWQ_min_a, DQ){
...
wq_pred = data.frame(d13C=numeric(0), d18O=numeric(0), d13C_sd=numeric(0), d18O_sd=numeric(0))
for(i in 1: nrow(sites)){
  wq_pred[i,] = sm_forward_evap(sites$Pa[i], sites$Tma[i], sites$PfWQ[i], sites$TmWQ_min_a[i], sites$Ra[i], sites$TmWQ_min_a[i], 3)
  
}
wq_pred$Site = sites$Site

dq_pred = data.frame(d13C=numeric(0), d18O=numeric(0), d13C_sd=numeric(0), d18O_sd=numeric(0))
for(i in 1: nrow(sites)){
  dq_pred[i,] = sm_forward_evap(sites$Pa[i], sites$Tma[i], sites$PfDQ[i], sites$TmDQ_min_a[i], sites$Ra[i], sites$TmWQ_min_a[i], sites$DQ[i])
...
## Plots of measured vs. predicted d13C and d18O values with Pa colors
wq_comp_pre = merge.data.frame(wq_pred, sites, by.x = "Site", by.y = "Site", all.x=TRUE)
dq_comp_pre = merge.data.frame(dq_pred, sites, by.x = "Site", by.y = "Site", all.x=TRUE)

wq_comp_pre = merge.data.frame(wq_comp_pre, data.aves, by.x = "Site", by.y = "Site", all.x=TRUE)
dq_comp_pre = merge.data.frame(dq_comp_pre, data.aves, by.x = "Site", by.y = "Site", all.x=TRUE)

# Blue scale for precipitation
c = ceiling(((wq_comp_pre$Pa) / 1000) * 5)
pal_Pa = brewer.pal(5, "Blues")
View(wq_comp_pre)
# Axes for d13C and d18O
d13C_al <- c(min(c((wq_comp_pre$d13C - wq_comp_pre$d13C_sd), (wq_comp_pre$d13C.measured - wq_comp_pre$d13C_sd), (dq_comp_pre$d13C - dq_comp_pre$d13C_sd), (dq_comp_pre$d13C.measured - dq_comp_pre$d13C_sd))), max(c((wq_comp_pre$d13C + wq_comp_pre$d13C_sd), (wq_comp_pre$d13C.measured + wq_comp_pre$d13C_sd), (dq_comp_pre$d13C + dq_comp_pre$d13C_sd), (dq_comp_pre$d13C.measured + dq_comp_pre$d13C_sd))))
d18O_al <- c(min(c((wq_comp_pre$d18O - wq_comp_pre$d18O_sd), (wq_comp_pre$d18O.measured - wq_comp_pre$d18O_sd), (dq_comp_pre$d18O - dq_comp_pre$d18O_sd), (dq_comp_pre$d18O.measured - dq_comp_pre$d18O_sd))), max(c((wq_comp_pre$d18O + wq_comp_pre$d18O_sd), (wq_comp_pre$d18O.measured + wq_comp_pre$d18O_sd), (dq_comp_pre$d18O + dq_comp_pre$d18O_sd), (dq_comp_pre$d18O.measured + dq_comp_pre$d18O_sd))))

setwd("C:/Users/femal/Dropbox/Soil_C_modeling/Modern/Figures/Current/")
...
par(mar=c(2,5,1,0))
plot(wq_comp_pre$d13C.measured, wq_comp_pre$d13C, pch=16, col=pal_Pa[c], xlim=d13C_al, ylim=d13C_al, main="", cex = 1.25,
     xlab="", cex.axis=1.25, cex.lab=1.25,
     ylab=expression(paste("Predicted ",delta^{13}, "C"[carbonate], "(\u2030)")),
     xaxt='n')
arrows(wq_comp_pre$d13C.measured, wq_comp_pre$d13C - wq_comp_pre$d13C_sd,wq_comp_pre$d13C.measured, wq_comp_pre$d13C + wq_comp_pre$d13C_sd, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
arrows(wq_comp_pre$d13C.measured - 1.10, wq_comp_pre$d13C, wq_comp_pre$d13C.measured + 1.10, wq_comp_pre$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq_comp_pre$d13C.measured, wq_comp_pre$d13C, pch=1, cex=1.3)
text(-15,5,"a", cex=1.5)


par(mar=c(2,5,1,1))
plot(wq_comp_pre$d18O.measured, wq_comp_pre$d18O, pch=16, col=pal_Pa[c], xlim=d18O_al, ylim=d18O_al,main="",cex = 1.25,
     xlab="",  cex.axis=1.25, cex.lab=1.25,
     ylab=expression(paste("Predicted ",delta^{18}, "O"[carbonate], "(\u2030)")),
     xaxt='n')
arrows(wq_comp_pre$d18O.measured, wq_comp_pre$d18O - wq_comp_pre$d18O_sd,wq_comp_pre$d18O.measured, wq_comp_pre$d18O + wq_comp_pre$d18O_sd, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
arrows(wq_comp_pre$d18O.measured - 1.09, wq_comp_pre$d18O, wq_comp_pre$d18O.measured + 1.09, wq_comp_pre$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq_comp_pre$d18O.measured, wq_comp_pre$d18O, pch=1, cex=1.3)
text(-17,2,"b", cex=1.5)

par(mar=c(4,5,0,0))
plot(dq_comp_pre$d13C.measured, dq_comp_pre$d13C, pch=16, col=pal_Pa[c], xlim=d13C_al, ylim=d13C_al, main="",cex = 1.25,
     xlab=expression(paste("Observed ",delta^{13},"C"[carbonate], "(\u2030)")),  cex.axis=1.25, cex.lab=1.25,
     ylab=expression(paste("Predicted ",delta^{13}, "C"[carbonate], "(\u2030)")))
arrows(dq_comp_pre$d13C.measured, dq_comp_pre$d13C - dq_comp_pre$d13C_sd,dq_comp_pre$d13C.measured, dq_comp_pre$d13C + dq_comp_pre$d13C_sd, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
arrows(dq_comp_pre$d13C.measured - 1.10, dq_comp_pre$d13C, dq_comp_pre$d13C.measured + 1.10, dq_comp_pre$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq_comp_pre$d13C.measured, dq_comp_pre$d13C, pch=1, cex=1.3)
text(-15,5,"c", cex=1.5)

par(mar=c(4,5,0,1))
plot(dq_comp_pre$d18O.measured, dq_comp_pre$d18O, pch=16, col=pal_Pa[c], xlim=d18O_al, ylim=d18O_al, main="",cex = 1.25,
     xlab=expression(paste("Observed ",delta^{18}, "O"[carbonate], "(\u2030)")),  cex.axis=1.25, cex.lab=1.25,
     ylab=expression(paste("Predicted ",delta^{18}, "O"[carbonate], "(\u2030)")))
arrows(dq_comp_pre$d18O.measured, dq_comp_pre$d18O - dq_comp_pre$d18O_sd,dq_comp_pre$d18O.measured, dq_comp_pre$d18O + dq_comp_pre$d18O_sd, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
arrows(dq_comp_pre$d18O.measured - 1.09, dq_comp_pre$d18O, dq_comp_pre$d18O.measured + 1.09, dq_comp_pre$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq_comp_pre$d18O.measured, dq_comp_pre$d18O, pch=1, cex=1.3)
text(-17,2,"d", cex=1.5)
...
pre_lm_dry_C <- lm(dq_comp_pre$d13C ~ dq_comp_pre$d13C.measured)
pre_lm_warm_O <- lm(wq_comp_pre$d18O ~ wq_comp_pre$d18O.measured)
pre_lm_dry_O <- lm(dq_comp_pre$d18O ~ dq_comp_pre$d18O.measured)

summary(pre_lm_warm_C)
summary(pre_lm_dry_C)
summary(pre_lm_warm_O)
...
pre_warm_C_rmse <- rmse(wq_comp_pre$d13C.measured - wq_comp_pre$d13C)
pre_dry_C_rmse <- rmse(dq_comp_pre$d13C.measured - dq_comp_pre$d13C)
pre_warm_O_rmse <- rmse(wq_comp_pre$d18O.measured - wq_comp_pre$d18O)
pre_dry_O_rmse <- rmse(dq_comp_pre$d18O.measured - dq_comp_pre$d18O)

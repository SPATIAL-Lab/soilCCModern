...
c = ceiling((wq.comp.opt$map.wc / 1000) * 5)

pal_map = brewer.pal(5, "Blues")

jpeg("OPT_results.jpg", units="in", res=300, width=8.5, height=7.5)

layout(matrix(c(1,2,3,4), 2, 2, byrow=T), heights=c(1,1.1,1,1.1), widths=c(1,1.05,1,1.05))
par(mar=c(2,5,1,0))
plot(wq.comp.opt$d13C.measured, wq.comp.opt$d13C, pch=16, col=pal_map[c], xlim=c(-13,4), ylim=c(-13,4), main="", cex = 1.25,
...
arrows(wq.comp.opt$d13C.measured - 1.10, wq.comp.opt$d13C, wq.comp.opt$d13C.measured + 1.10, wq.comp.opt$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
par(mar=c(2,5,1,1))
plot(wq.comp.opt$d18O.measured, wq.comp.opt$d18O, pch=16, col=pal_map[c], xlim=c(-17,1), ylim=c(-17,1),main="",cex = 1.25,
     xlab="",  cex.axis=1.25, cex.lab=1.25,
...
arrows(wq.comp.opt$d18O.measured - 1.09, wq.comp.opt$d18O, wq.comp.opt$d18O.measured + 1.09, wq.comp.opt$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(wq.comp.opt$d18O.measured, wq.comp.opt$d18O, pch=1, cex=1.3)
text(-17,1,"b", cex=1.5)

par(mar=c(4,5,0,0))
plot(dq.comp.opt$d13C.measured, dq.comp.opt$d13C, pch=16, col=pal_map[c], xlim=c(-13,4), ylim=c(-13,4), main="",cex = 1.25,
...
arrows(dq.comp.opt$d13C.measured - 1.10, dq.comp.opt$d13C, dq.comp.opt$d13C.measured + 1.10, dq.comp.opt$d13C, angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
points(dq.comp.opt$d13C.measured, dq.comp.opt$d13C, pch=1, cex=1.3)
text(-13,4,"c", cex=1.5)

par(mar=c(4,5,0,1))
plot(dq.comp.opt$d18O.measured, dq.comp.opt$d18O, pch=16, col=pal_map[c], xlim=c(-17,1), ylim=c(-17,1), main="",cex = 1.25,
...
arrows(dq.comp.opt$d18O.measured - 1.09, dq.comp.opt$d18O, dq.comp.opt$d18O.measured + 1.09, dq.comp.opt$d18O,  angle=90, length=0.1, code = 3, col=alpha("black", 0.2))
abline(0,1)
...
## Basic stats
opt_lm_hot_C <- lm(wq.comp.opt$d13C ~ wq.comp.opt$d13C.measured)
opt_lm_dry_C <- lm(dq.comp.opt$d13C ~ dq.comp.opt$d13C.measured)
opt_lm_hot_O <- lm(wq.comp.opt$d18O ~ wq.comp.opt$d18O.measured)
...
opt_hot_C_rmse <- rmse(wq.comp.opt$d13C.measured - wq.comp.opt$d13C)
opt_dry_C_rmse <- rmse(dq.comp.opt$d13C.measured - dq.comp.opt$d13C)
opt_hot_O_rmse <- rmse(wq.comp.opt$d18O.measured - wq.comp.opt$d18O)
